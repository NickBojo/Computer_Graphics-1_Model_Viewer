...
void display()
{
	...
	glColor3ub(255,150,150);					// Set Colour
	inSimple.Create();							// Create Model
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("478 Assignment 1");
	...
	inSimple.Load(inPath);					// Load the Model file, using the specified path
